...
template <typename Ret, typename... Args>
struct fixed_function_vtable<construct_type::none, Ret,
                             Args...> : fixed_function_vtable_base<Ret,
                                                                   Args...> {};

template <typename Ret, typename... Args>
struct fixed_function_vtable<construct_type::copy, Ret,
                             Args...> : fixed_function_vtable_base<Ret,
                                                                   Args...> {
...
template <typename Ret, typename... Args>
struct fixed_function_vtable<construct_type::move, Ret,
                             Args...> : fixed_function_vtable_base<Ret,
                                                                   Args...> {
...
template <typename Ret, typename... Args>
struct fixed_function_vtable<construct_type::copy_and_move, Ret,
                             Args...> : fixed_function_vtable_base<Ret,
                                                                   Args...> {
  void (*copy)(const void *, void *) = nullptr;
  void (*move)(void *, void *) = nullptr;
...
class fixed_size_function<Ret(Args...), MaxSize, ConstructStrategy> {
 public:
  ...
  using is_copyable = std::integral_constant < bool,
        ConstructStrategy == construct_type::copy ||
            ConstructStrategy == construct_type::copy_and_move > ;
  using is_movable = std::integral_constant < bool,
 ...
 public:
  ...
  fixed_size_function() : vtable_(), storage_() {}

  ~fixed_size_function() { reset(); }

  explicit fixed_size_function(std::nullptr_t) : vtable_(), storage_() {}
  ...
  fixed_size_function(fixed_size_function const &src) : vtable_(), storage_() { copy(src); }
  ...
  fixed_size_function(fixed_size_function &&src) : vtable_(), storage_() {
  ...
  explicit fixed_size_function(Functor &&f) : vtable_(), storage_() {
 ...
 private:
  ...
  void move(fixed_size_function &&src,
            __attribute__((unused)) std::true_type movable) {
    if (src.vtable_.move) {
  ...
  void move(fixed_size_function const &src,
            __attribute__((unused)) std::false_type movable) {
    copy(src);
  }
 ...
 private:
  ...
  template <typename Functor>
  static void init_copy(std::false_type /*copyable*/) {}
  ...
  template <typename Functor>
  static void init_move(std::false_type /*movable*/) {}
